...
import { Inspection, CreateInspectionResponse, InspectionsResponse, CreateInspectionBody } from '../models/inspection.model';
...
export class ProjectsService {
  ...
  createInspection(data: CreateInspectionBody): Observable<Inspection> {
